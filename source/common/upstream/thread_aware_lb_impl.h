...
private:
  ...
  struct LoadBalancerImpl : public LoadBalancer {
    ...
    // std::shared_ptr<HealthyAndDegradedLoad> healthy_and_degraded_per_priority_load_;
  ...
  struct LoadBalancerFactoryImpl : public LoadBalancerFactory {
    ...
    // std::shared_ptr<HealthyAndDegradedLoad> healthy_and_degraded_per_priority_load_ ABSL_GUARDED_BY(mutex_);
