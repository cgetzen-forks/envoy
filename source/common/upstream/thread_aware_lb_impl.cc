...
LoadBalancerSharedPtr ThreadAwareLoadBalancerBase::LoadBalancerFactoryImpl::create(const ClusterInfoConstSharedPtr& , LoadBalancerFactoryContext& ) {
  return create();
}
LoadBalancerSharedPtr ThreadAwareLoadBalancerBase::LoadBalancerFactoryImpl::create() {
